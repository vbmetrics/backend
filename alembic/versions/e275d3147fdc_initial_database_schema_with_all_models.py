...
Revision ID: e275d3147fdc
Revises:
Create Date: 2025-08-14 15:11:04.763988
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("name", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
        sa.Column(
            "type", sa.Enum("club", "national", name="seasontype"), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "dominant_hand",
            sa.Enum("right", "left", "ambidextrous", name="playerhand"),
            nullable=True,
        ),
        ...
        sa.Column(
            "nationality_code", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "role_type",
            sa.Enum("head_coach", "assistant", name="staffroletype"),
            nullable=True,
        ),
        sa.Column(
            "nationality_code", sqlmodel.sql.sqltypes.AutoString(), nullable=False
    ...
    op.create_table(
        ...
        sa.Column("name", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
        sa.Column(
            "team_type", sa.Enum("club", "national", name="teamtype"), nullable=True
        ),
